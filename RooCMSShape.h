...
class RooErfcExpoPdf : public RooAbsPdf {
public:
  RooErfcExpoPdf() {}
  RooErfcExpoPdf(const char *name, const char *title,
	      RooAbsReal& _x,
	      RooAbsReal& _mpv,
	      RooAbsReal& _beta,
	      RooAbsReal& _gamma,
  ...
  RooErfcExpoPdf(const RooErfcExpoPdf& other, const char* name);
  inline virtual TObject* clone(const char* newname) const { return new RooErfcExpoPdf(*this,newname); }
  inline ~RooErfcExpoPdf() {}
  Double_t evaluate() const ;
  

  //ClassDef(RooErfcExpoPdf,1);
